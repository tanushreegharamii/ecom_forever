...
const Product = () => {
      ...
      <div className='flex flex-col gap-4 my-8'>
        ...
        <div className='flex gap-2 '>
          {productData.sizes.map((item, index)=>(
            <button onClick={()=>setSizes(item)} className={`py-2 border px-4 bg-gray-100 ${item === sizes ? 'border-orange-400' : '' }`} key={index} >{item}</button>
          ))}
        </div>
      </div>
  ...
  <div className='mt-20'>
    ...
    <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem expedita voluptates asperiores a possimus. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab, consequatur.</p>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis non earum est voluptatem debitis? Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe voluptas a optio, dolore enim architecto accusantium fuga libero quisquam neque.</p>
    </div>
  </div>
